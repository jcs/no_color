...
| [Apt](https://tracker.debian.org/pkg/apt) | `apt -o DPkg::Progress-Fancy=false -o APT::Color=false`\
or add\
`Binary::apt::DPkg::Progress-Fancy "false";` and `Binary::apt::APT::Color "false";`\
